...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    o.VERSION = "3.4.0", o.TRANSITION_DURATION = 150, o.prototype.close = function(e) {
        function i() {
    ...
    i.VERSION = "3.4.0", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        interval: 5e3,
        pause: "hover",
        wrap: !0,
        keyboard: !0
    ...
    a.VERSION = "3.4.0", a.prototype.toggle = function(o) {
        var n = t(this);
    ...
    i.VERSION = "3.4.0", i.TRANSITION_DURATION = 300, i.BACKDROP_TRANSITION_DURATION = 150, i.DEFAULTS = {
        backdrop: !0,
        keyboard: !0,
        show: !0
    ...
    i.VERSION = "3.4.0", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        animation: !0,
        placement: "top",
        selector: !1,
    ...
    i.VERSION = "3.4.0", i.DEFAULTS = t.extend({}, t.fn.tooltip.Constructor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
    ...
    i.VERSION = "3.4.0", i.TRANSITION_DURATION = 150, i.prototype.show = function() {
        var e = this.element,
    ...
    i.VERSION = "3.4.0", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        offset: 0,
        target: window
    ...
    o.VERSION = "3.4.0", o.TRANSITION_DURATION = 350, o.DEFAULTS = {
        toggle: !0
